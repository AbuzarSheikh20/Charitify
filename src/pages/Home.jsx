      ...
      <section className="w-full flex justify-between h-[772px] px-[80px] items-center bg-[#f9f6f2]">
        <div className="flex flex-col justify-center items-center pr-10 self-center">
          <SectionHeader
            ...
            mainHeading={
              <>
                <span>Small Actions Lead</span>
                <br />
                <span>To Big Changes</span>
              </>
            }
          ...
          <div className="flex justify-between w-[550px] pb-[60px] ml-16">
            <div className="flex items-center">
              <img
                src={assets.trustedHandSvg}
                alt="Volunteers"
                className="w-[50px] mr-4"
              />
              <div className="flex flex-col">
                <span className="medium text-[#FF8363] leading-none">
                  3,750
                </span>
                <span className="medium text-black leading-none">
                  Volunteers
                </span>
              </div>
            </div>
          ...
          <div className="flex justify-start w-full ml-28">
            <NavLink to={'/contact'}>
              <button className="mt-4  border-2 border-[#FF8363] rounded-t-3xl rounded-bl-3xl text-[#FF8363] hover:bg-[#FF8363] hover:text-white px-12 py-2 transition-all duration-300">
                Become a Volunteer
              </button>
            </NavLink>
          </div>
        ...
        <div className="flex-1 max-w-lg relative -top-[45px] bg-transparent rounded-bl-[50px] overflow-hidden">
          <div className="w-full bg-[#FF8363] py-[30px] px-[50px] relative rounded-t-[50px] flex items-center justify-between">
            <div className="flex items-center gap-[50px]">
              ...
              <span className="medium text-white leading-[100%]">
          ...
          <form className="bg-[#104221] flex flex-col shadow-lg p-[50px]">
            ...
            <label
              className="btn-text text-[#E9EBF8]/65 mb-2"
              htmlFor="fullName"
            >
              Full name
            </label>
            <input
              name="fullName"
              type="text"
              className="rounded-md px-4 py-2 mb-6 bg-[#E9EBF8]/65 outline-none"
            />

            <label className="btn-text text-[#E9EBF8]/65 mb-2" htmlFor="email">
              Email address
            </label>
            <input
              name="email"
            ...
            <label className="btn-text text-[#E9EBF8]/65 mb-2" htmlFor="causes">
              Select Causes
            </label>
            <input
              name="causes"
              ...
              className="rounded-md px-4 py-2 mb-6 bg-[#E9EBF8]/65 outline-none"
            />
            <label className="btn-text text-[#E9EBF8]/65 mb-2" htmlFor="amount">
              Amount
            </label>
            <div className="flex flex-col gap-2">
              ...
              <input
                type="number"
                className="rounded-md px-4 py-2 mb-6 bg-[#E9EBF8]/65 appearance-none outline-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
              />
            </div>
            <div className="flex flex-col gap-2 mt-2">
              <span className="btn-text text-[#E9EBF8]/65 mb-1">
                Payment Method
              </span>
      ...
      <section className="w-full bg-[#00A676] px-[80px] flex flex-col justify-center items-start">
        <div className="pt-[120px] pb-[100px]">
          <SectionHeader
            ...
            mainHeading={
              <>
                <span>We Provide Effortless</span>
                <br />
                <span>Help To People</span>
              </>
            }
          ...
          {cardData.map((card, idx) => (
            ...
            >
              <div className="flex flex-col flex-1 p-6">
                <h3
                  className="medium-28 mb-2 text-[#00A676]"
                  style={{ fontWeight: 700 }}
                >
                  {card.title}
                </h3>
                <p className="text-[22px] text-[#8D9099] mb-4 flex-1 font-itim">
                  {card.desc}
                </p>
                <a
                  href={card.link}
      ...
      <section className="w-full bg-[#FEF4EB] px-[80px] py-[100px]">
        ...
        <div className="grid grid-cols-3 gap-[90px] justify-between mb-[100px]">
          <div className="flex items-center gap-[25px]">
            ...
            <span className="medium-28" style={{ fontWeight: "700" }}>
              Featured Campaign
            </span>
          </div>
          <div className="flex items-center gap-[25px]">
      ...
      <section className="px-[80px] py-[100px]">
        <div className="grid grid-cols-3 gap-[40px] rounded-[50px] overflow-hidden">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-[#00A676] medium-24">Image Gallery</h3>
